...
export type CreateCustomerEventInput = {
  /** The components used to create the event's content. */
  components: Array<ComponentInput>;
  /** The customerId of the customer that the event is for. */
  customerIdentifier: CustomerIdentifierInput;
  /** The external ID of this event. You can use this field to store your own unique identifier for this event. */
  externalId?: InputMaybe<Scalars['ID']>;
  /** The (optional) threadId of the thread that the event is for. This is useful if you want to associate the event to a particular thread. */
...
export type ThreadPriorityChangedEntry = {
  ...
  nextPriority: Maybe<Scalars['Int']>;
  previousPriority: Maybe<Scalars['Int']>;
};
...
export type ThreadStatusTransitionedEntry = {
  ...
  nextStatus: Maybe<ThreadStatus>;
  previousStatus: Maybe<ThreadStatus>;
};
