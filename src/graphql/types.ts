...
export type ServiceLevelAgreementsStatus = {
  __typename?: 'ServiceLevelAgreementsStatus';
...
export type Thread = {
  ...
  priority: Scalars['Int'];
  serviceLevelAgreementStatus: Maybe<ServiceLevelAgreementsStatus>;
  /** If this thread has a linked SLA, this will inform on the status of its objectives. */
  serviceLevelAgreementsStatus: Maybe<ServiceLevelAgreementsStatus>;
