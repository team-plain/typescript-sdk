...
export type LinearIssueThreadLinkGroup = ThreadLinkGroup & {
  __typename?: 'LinearIssueThreadLinkGroup';
  description: Maybe<Scalars['String']>;
  id: Scalars['ID'];
  linearStateType: LinearIssueStateType;
  status: ThreadLinkGroupStatus;
...
export type LinearIssueThreadLinkGroupThreadsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
export type ThreadLinkGroupFilter = {
  companyIds?: InputMaybe<Array<Scalars['ID']>>;
  threadLinkGroupIds?: InputMaybe<Array<Scalars['ID']>>;
  tierIds?: InputMaybe<Array<Scalars['ID']>>;
};

/**
 * Represents a simplified, high-level status of a thread link group which can be used for filtering and sorting.
 * Statuses from different issue tracking systems (e.g., Linear, Jira, GitHub Issues) are mapped to one of these values.
 */
export enum ThreadLinkGroupStatus {
  /**
   * Indicates that the issue has been finished.
   * This includes granular statuses like "Completed", "Done", "Resolved", "Cancelled", ...etc
   */
  Done = 'DONE',
  /**
   * Indicates that the issue has been started but is not yet completed.
   * This includes granular statuses like "Started", "In Progress", "In Review", "Blocked", ...etc
   */
  InProgress = 'IN_PROGRESS',
  /**
   * Indicates that the issue has not been started.
   * This includes granular statuses like "Backlog", "Triage", "Unstarted", "Planned", ...etc
   */
  Todo = 'TODO'
}
...
type ThreadStatusDetailParts_ThreadStatusDetailCreated_Fragment = { __typename: 'ThreadStatusDetailCreated', createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } };

type ThreadStatusDetailParts_ThreadStatusDetailDoneAutomaticallySet_Fragment = { __typename?: 'ThreadStatusDetailDoneAutomaticallySet', afterSeconds: number | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } };

type ThreadStatusDetailParts_ThreadStatusDetailDoneManuallySet_Fragment = { __typename?: 'ThreadStatusDetailDoneManuallySet', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } };

type ThreadStatusDetailParts_ThreadStatusDetailIgnored_Fragment = { __typename?: 'ThreadStatusDetailIgnored', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } };

type ThreadStatusDetailParts_ThreadStatusDetailInProgress_Fragment = { __typename?: 'ThreadStatusDetailInProgress', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } };

type ThreadStatusDetailParts_ThreadStatusDetailLinearUpdated_Fragment = { __typename?: 'ThreadStatusDetailLinearUpdated' };

type ThreadStatusDetailParts_ThreadStatusDetailNewReply_Fragment = { __typename: 'ThreadStatusDetailNewReply', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } };

type ThreadStatusDetailParts_ThreadStatusDetailReplied_Fragment = { __typename?: 'ThreadStatusDetailReplied' };

type ThreadStatusDetailParts_ThreadStatusDetailSnoozed_Fragment = { __typename?: 'ThreadStatusDetailSnoozed' };

type ThreadStatusDetailParts_ThreadStatusDetailThreadDiscussionResolved_Fragment = { __typename?: 'ThreadStatusDetailThreadDiscussionResolved', threadDiscussionId: string | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } };

type ThreadStatusDetailParts_ThreadStatusDetailThreadLinkUpdated_Fragment = { __typename: 'ThreadStatusDetailThreadLinkUpdated', linearIssueId: string | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } };

type ThreadStatusDetailParts_ThreadStatusDetailUnsnoozed_Fragment = { __typename?: 'ThreadStatusDetailUnsnoozed' };

type ThreadStatusDetailParts_ThreadStatusDetailWaitingForCustomer_Fragment = { __typename?: 'ThreadStatusDetailWaitingForCustomer', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } };

type ThreadStatusDetailParts_ThreadStatusDetailWaitingForDuration_Fragment = { __typename?: 'ThreadStatusDetailWaitingForDuration', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, waitingUntil: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } };
...
export type ChangeThreadPriorityMutation = { __typename?: 'Mutation', changeThreadPriority: { __typename?: 'ChangeThreadPriorityOutput', thread: { __typename: 'Thread', id: string, externalId: string | null, status: ThreadStatus, title: string, description: string | null, previewText: string | null, priority: number, customer: { __typename?: 'Customer', id: string }, statusDetail: { __typename: 'ThreadStatusDetailCreated', createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailDoneAutomaticallySet', afterSeconds: number | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailDoneManuallySet', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailIgnored', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailInProgress', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailLinearUpdated' } | { __typename: 'ThreadStatusDetailNewReply', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailReplied' } | { __typename?: 'ThreadStatusDetailSnoozed' } | { __typename?: 'ThreadStatusDetailThreadDiscussionResolved', threadDiscussionId: string | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename: 'ThreadStatusDetailThreadLinkUpdated', linearIssueId: string | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailUnsnoozed' } | { __typename?: 'ThreadStatusDetailWaitingForCustomer', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailWaitingForDuration', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, waitingUntil: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, labels: Array<{ __typename: 'Label', id: string, labelType: { __typename: 'LabelType', id: string, name: string, icon: string | null, isArchived: boolean, archivedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } | null, archivedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } | null, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }>, threadFields: Array<{ __typename: 'ThreadField', id: string, key: string, type: ThreadFieldSchemaType, threadId: string, stringValue: string | null, booleanValue: boolean | null, isAiGenerated: boolean, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }>, assignedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } | null, assignedTo: { __typename: 'MachineUser', id: string, fullName: string, publicName: string, description: string | null, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename: 'System', id: string } | { __typename: 'User', id: string, fullName: string, publicName: string, email: string, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | null, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'CustomerActor', customerId: string } | { __typename: 'DeletedCustomerActor', customerId: string } | { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'CustomerActor', customerId: string } | { __typename: 'DeletedCustomerActor', customerId: string } | { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } } | null, error: { __typename: 'MutationError', message: string, type: MutationErrorType, code: string, fields: Array<{ __typename?: 'MutationFieldError', field: string, message: string, type: MutationFieldErrorType }> } | null } };
...
export type CreateLabelTypeMutationVariables = Exact<{
  input: CreateLabelTypeInput;
}>;


export type CreateLabelTypeMutation = { __typename?: 'Mutation', createLabelType: { __typename?: 'CreateLabelTypeOutput', labelType: { __typename: 'LabelType', id: string, name: string, icon: string | null, isArchived: boolean, archivedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } | null, archivedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } | null, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } } | null, error: { __typename: 'MutationError', message: string, type: MutationErrorType, code: string, fields: Array<{ __typename?: 'MutationFieldError', field: string, message: string, type: MutationFieldErrorType }> } | null } };
...
export type CreateThreadMutation = { __typename?: 'Mutation', createThread: { __typename?: 'CreateThreadOutput', thread: { __typename: 'Thread', id: string, externalId: string | null, status: ThreadStatus, title: string, description: string | null, previewText: string | null, priority: number, customer: { __typename?: 'Customer', id: string }, statusDetail: { __typename: 'ThreadStatusDetailCreated', createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailDoneAutomaticallySet', afterSeconds: number | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailDoneManuallySet', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailIgnored', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailInProgress', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailLinearUpdated' } | { __typename: 'ThreadStatusDetailNewReply', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailReplied' } | { __typename?: 'ThreadStatusDetailSnoozed' } | { __typename?: 'ThreadStatusDetailThreadDiscussionResolved', threadDiscussionId: string | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename: 'ThreadStatusDetailThreadLinkUpdated', linearIssueId: string | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailUnsnoozed' } | { __typename?: 'ThreadStatusDetailWaitingForCustomer', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailWaitingForDuration', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, waitingUntil: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, labels: Array<{ __typename: 'Label', id: string, labelType: { __typename: 'LabelType', id: string, name: string, icon: string | null, isArchived: boolean, archivedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } | null, archivedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } | null, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }>, threadFields: Array<{ __typename: 'ThreadField', id: string, key: string, type: ThreadFieldSchemaType, threadId: string, stringValue: string | null, booleanValue: boolean | null, isAiGenerated: boolean, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }>, assignedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } | null, assignedTo: { __typename: 'MachineUser', id: string, fullName: string, publicName: string, description: string | null, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename: 'System', id: string } | { __typename: 'User', id: string, fullName: string, publicName: string, email: string, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | null, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'CustomerActor', customerId: string } | { __typename: 'DeletedCustomerActor', customerId: string } | { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'CustomerActor', customerId: string } | { __typename: 'DeletedCustomerActor', customerId: string } | { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } } | null, error: { __typename: 'MutationError', message: string, type: MutationErrorType, code: string, fields: Array<{ __typename?: 'MutationFieldError', field: string, message: string, type: MutationFieldErrorType }> } | null } };
...
export type MarkThreadAsDoneMutation = { __typename?: 'Mutation', markThreadAsDone: { __typename?: 'MarkThreadAsDoneOutput', thread: { __typename: 'Thread', id: string, externalId: string | null, status: ThreadStatus, title: string, description: string | null, previewText: string | null, priority: number, customer: { __typename?: 'Customer', id: string }, statusDetail: { __typename: 'ThreadStatusDetailCreated', createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailDoneAutomaticallySet', afterSeconds: number | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailDoneManuallySet', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailIgnored', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailInProgress', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailLinearUpdated' } | { __typename: 'ThreadStatusDetailNewReply', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailReplied' } | { __typename?: 'ThreadStatusDetailSnoozed' } | { __typename?: 'ThreadStatusDetailThreadDiscussionResolved', threadDiscussionId: string | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename: 'ThreadStatusDetailThreadLinkUpdated', linearIssueId: string | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailUnsnoozed' } | { __typename?: 'ThreadStatusDetailWaitingForCustomer', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailWaitingForDuration', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, waitingUntil: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, labels: Array<{ __typename: 'Label', id: string, labelType: { __typename: 'LabelType', id: string, name: string, icon: string | null, isArchived: boolean, archivedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } | null, archivedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } | null, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }>, threadFields: Array<{ __typename: 'ThreadField', id: string, key: string, type: ThreadFieldSchemaType, threadId: string, stringValue: string | null, booleanValue: boolean | null, isAiGenerated: boolean, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }>, assignedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } | null, assignedTo: { __typename: 'MachineUser', id: string, fullName: string, publicName: string, description: string | null, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename: 'System', id: string } | { __typename: 'User', id: string, fullName: string, publicName: string, email: string, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | null, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'CustomerActor', customerId: string } | { __typename: 'DeletedCustomerActor', customerId: string } | { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'CustomerActor', customerId: string } | { __typename: 'DeletedCustomerActor', customerId: string } | { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } } | null, error: { __typename: 'MutationError', message: string, type: MutationErrorType, code: string, fields: Array<{ __typename?: 'MutationFieldError', field: string, message: string, type: MutationFieldErrorType }> } | null } };
...
export type MarkThreadAsTodoMutation = { __typename?: 'Mutation', markThreadAsTodo: { __typename?: 'MarkThreadAsTodoOutput', thread: { __typename: 'Thread', id: string, externalId: string | null, status: ThreadStatus, title: string, description: string | null, previewText: string | null, priority: number, customer: { __typename?: 'Customer', id: string }, statusDetail: { __typename: 'ThreadStatusDetailCreated', createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailDoneAutomaticallySet', afterSeconds: number | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailDoneManuallySet', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailIgnored', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailInProgress', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailLinearUpdated' } | { __typename: 'ThreadStatusDetailNewReply', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailReplied' } | { __typename?: 'ThreadStatusDetailSnoozed' } | { __typename?: 'ThreadStatusDetailThreadDiscussionResolved', threadDiscussionId: string | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename: 'ThreadStatusDetailThreadLinkUpdated', linearIssueId: string | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailUnsnoozed' } | { __typename?: 'ThreadStatusDetailWaitingForCustomer', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailWaitingForDuration', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, waitingUntil: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, labels: Array<{ __typename: 'Label', id: string, labelType: { __typename: 'LabelType', id: string, name: string, icon: string | null, isArchived: boolean, archivedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } | null, archivedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } | null, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }>, threadFields: Array<{ __typename: 'ThreadField', id: string, key: string, type: ThreadFieldSchemaType, threadId: string, stringValue: string | null, booleanValue: boolean | null, isAiGenerated: boolean, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }>, assignedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } | null, assignedTo: { __typename: 'MachineUser', id: string, fullName: string, publicName: string, description: string | null, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename: 'System', id: string } | { __typename: 'User', id: string, fullName: string, publicName: string, email: string, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | null, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'CustomerActor', customerId: string } | { __typename: 'DeletedCustomerActor', customerId: string } | { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'CustomerActor', customerId: string } | { __typename: 'DeletedCustomerActor', customerId: string } | { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } } | null, error: { __typename: 'MutationError', message: string, type: MutationErrorType, code: string, fields: Array<{ __typename?: 'MutationFieldError', field: string, message: string, type: MutationFieldErrorType }> } | null } };
...
export type SnoozeThreadMutation = { __typename?: 'Mutation', snoozeThread: { __typename?: 'SnoozeThreadOutput', thread: { __typename: 'Thread', id: string, externalId: string | null, status: ThreadStatus, title: string, description: string | null, previewText: string | null, priority: number, customer: { __typename?: 'Customer', id: string }, statusDetail: { __typename: 'ThreadStatusDetailCreated', createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailDoneAutomaticallySet', afterSeconds: number | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailDoneManuallySet', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailIgnored', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailInProgress', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailLinearUpdated' } | { __typename: 'ThreadStatusDetailNewReply', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailReplied' } | { __typename?: 'ThreadStatusDetailSnoozed' } | { __typename?: 'ThreadStatusDetailThreadDiscussionResolved', threadDiscussionId: string | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename: 'ThreadStatusDetailThreadLinkUpdated', linearIssueId: string | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailUnsnoozed' } | { __typename?: 'ThreadStatusDetailWaitingForCustomer', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailWaitingForDuration', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, waitingUntil: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, labels: Array<{ __typename: 'Label', id: string, labelType: { __typename: 'LabelType', id: string, name: string, icon: string | null, isArchived: boolean, archivedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } | null, archivedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } | null, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }>, threadFields: Array<{ __typename: 'ThreadField', id: string, key: string, type: ThreadFieldSchemaType, threadId: string, stringValue: string | null, booleanValue: boolean | null, isAiGenerated: boolean, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }>, assignedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } | null, assignedTo: { __typename: 'MachineUser', id: string, fullName: string, publicName: string, description: string | null, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename: 'System', id: string } | { __typename: 'User', id: string, fullName: string, publicName: string, email: string, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | null, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'CustomerActor', customerId: string } | { __typename: 'DeletedCustomerActor', customerId: string } | { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'CustomerActor', customerId: string } | { __typename: 'DeletedCustomerActor', customerId: string } | { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } } | null, error: { __typename: 'MutationError', message: string, type: MutationErrorType, code: string, fields: Array<{ __typename?: 'MutationFieldError', field: string, message: string, type: MutationFieldErrorType }> } | null } };
...
export type UnassignThreadMutation = { __typename?: 'Mutation', unassignThread: { __typename?: 'UnassignThreadOutput', thread: { __typename: 'Thread', id: string, externalId: string | null, status: ThreadStatus, title: string, description: string | null, previewText: string | null, priority: number, customer: { __typename?: 'Customer', id: string }, statusDetail: { __typename: 'ThreadStatusDetailCreated', createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailDoneAutomaticallySet', afterSeconds: number | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailDoneManuallySet', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailIgnored', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailInProgress', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailLinearUpdated' } | { __typename: 'ThreadStatusDetailNewReply', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailReplied' } | { __typename?: 'ThreadStatusDetailSnoozed' } | { __typename?: 'ThreadStatusDetailThreadDiscussionResolved', threadDiscussionId: string | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename: 'ThreadStatusDetailThreadLinkUpdated', linearIssueId: string | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailUnsnoozed' } | { __typename?: 'ThreadStatusDetailWaitingForCustomer', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailWaitingForDuration', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, waitingUntil: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, labels: Array<{ __typename: 'Label', id: string, labelType: { __typename: 'LabelType', id: string, name: string, icon: string | null, isArchived: boolean, archivedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } | null, archivedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } | null, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }>, threadFields: Array<{ __typename: 'ThreadField', id: string, key: string, type: ThreadFieldSchemaType, threadId: string, stringValue: string | null, booleanValue: boolean | null, isAiGenerated: boolean, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }>, assignedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } | null, assignedTo: { __typename: 'MachineUser', id: string, fullName: string, publicName: string, description: string | null, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename: 'System', id: string } | { __typename: 'User', id: string, fullName: string, publicName: string, email: string, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | null, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'CustomerActor', customerId: string } | { __typename: 'DeletedCustomerActor', customerId: string } | { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'CustomerActor', customerId: string } | { __typename: 'DeletedCustomerActor', customerId: string } | { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } } | null, error: { __typename: 'MutationError', message: string, type: MutationErrorType, code: string, fields: Array<{ __typename?: 'MutationFieldError', field: string, message: string, type: MutationFieldErrorType }> } | null } };
...
export type CustomerByExternalIdQueryVariables = Exact<{
  externalId: Scalars['ID'];
}>;


export type CustomerByExternalIdQuery = { __typename?: 'Query', customerByExternalId: { __typename: 'Customer', id: string, fullName: string, shortName: string | null, externalId: string | null, email: { __typename?: 'EmailAddress', email: string, isVerified: boolean, verifiedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } | null }, company: { __typename: 'Company', id: string, name: string, domainName: string, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } } | null, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename?: 'CustomerActor' } | { __typename?: 'DeletedCustomerActor' } | { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, markedAsSpamAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } | null } | null };
...
export type ThreadQuery = { __typename?: 'Query', thread: { __typename: 'Thread', id: string, externalId: string | null, status: ThreadStatus, title: string, description: string | null, previewText: string | null, priority: number, customer: { __typename?: 'Customer', id: string }, statusDetail: { __typename: 'ThreadStatusDetailCreated', createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailDoneAutomaticallySet', afterSeconds: number | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailDoneManuallySet', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailIgnored', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailInProgress', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailLinearUpdated' } | { __typename: 'ThreadStatusDetailNewReply', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailReplied' } | { __typename?: 'ThreadStatusDetailSnoozed' } | { __typename?: 'ThreadStatusDetailThreadDiscussionResolved', threadDiscussionId: string | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename: 'ThreadStatusDetailThreadLinkUpdated', linearIssueId: string | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailUnsnoozed' } | { __typename?: 'ThreadStatusDetailWaitingForCustomer', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailWaitingForDuration', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, waitingUntil: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, labels: Array<{ __typename: 'Label', id: string, labelType: { __typename: 'LabelType', id: string, name: string, icon: string | null, isArchived: boolean, archivedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } | null, archivedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } | null, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }>, threadFields: Array<{ __typename: 'ThreadField', id: string, key: string, type: ThreadFieldSchemaType, threadId: string, stringValue: string | null, booleanValue: boolean | null, isAiGenerated: boolean, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }>, assignedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } | null, assignedTo: { __typename: 'MachineUser', id: string, fullName: string, publicName: string, description: string | null, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename: 'System', id: string } | { __typename: 'User', id: string, fullName: string, publicName: string, email: string, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | null, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'CustomerActor', customerId: string } | { __typename: 'DeletedCustomerActor', customerId: string } | { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'CustomerActor', customerId: string } | { __typename: 'DeletedCustomerActor', customerId: string } | { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } } | null };
...
export type ThreadByExternalIdQuery = { __typename?: 'Query', threadByExternalId: { __typename: 'Thread', id: string, externalId: string | null, status: ThreadStatus, title: string, description: string | null, previewText: string | null, priority: number, customer: { __typename?: 'Customer', id: string }, statusDetail: { __typename: 'ThreadStatusDetailCreated', createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailDoneAutomaticallySet', afterSeconds: number | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailDoneManuallySet', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailIgnored', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailInProgress', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailLinearUpdated' } | { __typename: 'ThreadStatusDetailNewReply', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailReplied' } | { __typename?: 'ThreadStatusDetailSnoozed' } | { __typename?: 'ThreadStatusDetailThreadDiscussionResolved', threadDiscussionId: string | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename: 'ThreadStatusDetailThreadLinkUpdated', linearIssueId: string | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailUnsnoozed' } | { __typename?: 'ThreadStatusDetailWaitingForCustomer', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailWaitingForDuration', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, waitingUntil: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, labels: Array<{ __typename: 'Label', id: string, labelType: { __typename: 'LabelType', id: string, name: string, icon: string | null, isArchived: boolean, archivedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } | null, archivedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } | null, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }>, threadFields: Array<{ __typename: 'ThreadField', id: string, key: string, type: ThreadFieldSchemaType, threadId: string, stringValue: string | null, booleanValue: boolean | null, isAiGenerated: boolean, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }>, assignedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } | null, assignedTo: { __typename: 'MachineUser', id: string, fullName: string, publicName: string, description: string | null, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename: 'System', id: string } | { __typename: 'User', id: string, fullName: string, publicName: string, email: string, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | null, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'CustomerActor', customerId: string } | { __typename: 'DeletedCustomerActor', customerId: string } | { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'CustomerActor', customerId: string } | { __typename: 'DeletedCustomerActor', customerId: string } | { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } } | null };
...
export type ThreadsQuery = { __typename?: 'Query', threads: { __typename?: 'ThreadConnection', edges: Array<{ __typename?: 'ThreadEdge', cursor: string, node: { __typename: 'Thread', id: string, externalId: string | null, status: ThreadStatus, title: string, description: string | null, previewText: string | null, priority: number, customer: { __typename?: 'Customer', id: string }, statusDetail: { __typename: 'ThreadStatusDetailCreated', createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailDoneAutomaticallySet', afterSeconds: number | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailDoneManuallySet', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailIgnored', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailInProgress', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailLinearUpdated' } | { __typename: 'ThreadStatusDetailNewReply', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailReplied' } | { __typename?: 'ThreadStatusDetailSnoozed' } | { __typename?: 'ThreadStatusDetailThreadDiscussionResolved', threadDiscussionId: string | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename: 'ThreadStatusDetailThreadLinkUpdated', linearIssueId: string | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailUnsnoozed' } | { __typename?: 'ThreadStatusDetailWaitingForCustomer', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename?: 'ThreadStatusDetailWaitingForDuration', statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, waitingUntil: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | null, statusChangedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, labels: Array<{ __typename: 'Label', id: string, labelType: { __typename: 'LabelType', id: string, name: string, icon: string | null, isArchived: boolean, archivedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } | null, archivedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } | null, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }>, threadFields: Array<{ __typename: 'ThreadField', id: string, key: string, type: ThreadFieldSchemaType, threadId: string, stringValue: string | null, booleanValue: boolean | null, isAiGenerated: boolean, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } }>, assignedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } | null, assignedTo: { __typename: 'MachineUser', id: string, fullName: string, publicName: string, description: string | null, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | { __typename: 'System', id: string } | { __typename: 'User', id: string, fullName: string, publicName: string, email: string, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | null, createdAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, createdBy: { __typename: 'CustomerActor', customerId: string } | { __typename: 'DeletedCustomerActor', customerId: string } | { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string }, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string }, updatedBy: { __typename: 'CustomerActor', customerId: string } | { __typename: 'DeletedCustomerActor', customerId: string } | { __typename: 'MachineUserActor', machineUserId: string } | { __typename: 'SystemActor', systemId: string } | { __typename: 'UserActor', userId: string } } }>, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor: string | null, endCursor: string | null } } };
