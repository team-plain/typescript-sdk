...
export type ThreadLinkGroup = {
  ...
  companyMetrics: Array<CompanyMetrics>;
  id: Scalars['ID'];
  threadLinks: ThreadLinkConnection;
  threads: ThreadConnection;
  tierMetrics: Array<TierMetrics>;
};
...
export type UserByIdQuery = { __typename?: 'Query', userById: { __typename: 'User', id: string, fullName: string, publicName: string, email: string, updatedAt: { __typename: 'DateTime', iso8601: string, unixTimestamp: string } } | null };
